...
//       success = loginStudent(formData.username, formData.password);
//     } else {
//       success = loginAdmin(formData.username, formData.password);
//     }
...
//                 Streamline your academic concerns with our modern, efficient complaint management system.
//               </p>
//             </div>
...
//                   Sign in to {loginType === 'student' ? 'manage your complaints' : 'access admin dashboard'}
//                 </p>
//                 {loginType === 'admin' && (
//                   <div className="mt-2 flex items-center justify-center space-x-2 text-sm text-blue-600">
//                     <Building className="h-4 w-4" />
//                     <span>Only main admin can register students by department</span>
//                   </div>
//                 )}
//               </div>
...
//                       placeholder={loginType === 'student' ? 'Enter your student ID' : 'Enter username'}
//                     />
//                   </div>
//                 </div>
...
//                   <p><strong>Student:</strong> CS001 / password123</p>
//                   <p><strong>Main Admin:</strong> admin / admin123 (can register students)</p>
//                   <p><strong>CS Dept Admin:</strong> csadmin / admin123 (view only)</p>
//                   <p><strong>EC Dept Admin:</strong> ecadmin / admin123 (view only)</p>
//                 </div>
//               </div>
//             </div>
//           </div>
...
import React, { useState } from 'react';
import { User, Lock, Shield, GraduationCap, Eye, EyeOff, UserCheck, BookOpen, Star, Award, Building } from 'lucide-react';
import { useAuth } from '../hooks/useAuth';
          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-4">
              <div className="flex items-center justify-center lg:justify-start space-x-3">
                ...
                <h1 className="text-3xl lg:text-4xl font-bold text-white">EduComplaint</h1>
              </div>
              <h2 className="text-4xl lg:text-6xl font-bold text-white leading-tight">
                Digital Complaint
                <span className="bg-gradient-to-r from-yellow-400 to-orange-500 bg-clip-text text-transparent"> Management</span>
              </h2>
              <p className="text-xl text-blue-100 max-w-lg">
                Streamline your academic concerns with our modern, efficient complaint management system.
              </p>
            ...
            <div className="bg-white/95 backdrop-blur-sm rounded-3xl shadow-2xl p-8 w-full max-w-md border border-white/20">
              ...
              <div className="flex bg-gray-100 rounded-xl p-1 mb-6">
                <button
                  ...
                  onClick={() => setLoginType('student')}
                  className={`flex-1 flex items-center justify-center space-x-2 py-3 px-4 rounded-lg font-medium transition-all duration-200 ${
                    loginType === 'student' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-600 hover:text-gray-900'
                  }`}
                >
                  <User className="h-4 w-4" />
                  <span>Student</span>
                ...
                <button
                  ...
                  onClick={() => setLoginType('admin')}
                  className={`flex-1 flex items-center justify-center space-x-2 py-3 px-4 rounded-lg font-medium transition-all duration-200 ${
                    loginType === 'admin' ? 'bg-white text-purple-600 shadow-sm' : 'text-gray-600 hover:text-gray-900'
                  }`}
                >
                  <Shield className="h-4 w-4" />
                  <span>Admin</span>
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-xl">
                ...
                <div className="text-xs text-gray-600 space-y-1">
                  <p>
                    <strong>Student:</strong> CS001 / password123
                  </p>
                  <p>
                    <strong>Main Admin:</strong> admin / admin123 (can register students)
                  </p>
                  <p>
                    <strong>CS Dept Admin:</strong> csadmin / admin123 (view only)
                  </p>
                  <p>
                    <strong>EC Dept Admin:</strong> ecadmin / admin123 (view only)
                  </p>
                </div>
              </div>
            </div>
